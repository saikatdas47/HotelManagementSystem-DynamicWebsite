...
<div class="container mt-3">
    <form action="rooms.php" method="POST" class="form-inline">
        ...
        <a href="rooms.php" class="btn btn-secondary mb-2 ml-2">Default</a>
    </form>
</div>
...
<h2 class="font-weight-bold text-center text-dark p-2 mt-1">Our Rooms</h2>
<div class="container mt-3">
    <div class="row">
